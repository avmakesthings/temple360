...
AFRAME.registerComponent("ui-menu-home", {
    ...
    init: function() {
        ...
        //get camera position
        var camPosition = document.getElementById("head").components.position
            .data;
        var menuPosition = {
            x: camPosition.x,
            y: camPosition.y + 0.2,
        ...
        textDescription.setAttribute("text", {
            value:
                "An A-frame based webVR interface for presenting the design, construction and installation of the 2017 Burning Man temple, set in space and time."
        });
