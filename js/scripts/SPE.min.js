...
"function" == typeof define && define.amd
    ...
    (SPE.TypedArrayHelper.prototype.setFromArray = function(a, b) {
        ...
        return (
            d > this.array.length
                ? this.grow(d)
                : d < this.array.length && this.shrink(d),
    ...
    (SPE.TypedArrayHelper.prototype.setMat3 = function(a, b) {
        ...
        return this.setFromArray(
            this.indexOffset + a * this.componentSize,
            b.elements
        );
    }),
    ...
    (SPE.TypedArrayHelper.prototype.setNumber = function(a, b) {
        "use strict";
        return (
            (this.array[this.indexOffset + a * this.componentSize] = b), this
        );
    }),
    ...
    (SPE.ShaderAttribute.prototype._ensureTypedArray = function(a) {
        ...
        (null !== this.typedArray &&
            this.typedArray.size === a * this.componentSize) ||
            (null !== this.typedArray && this.typedArray.size !== a
                ? this.typedArray.setSize(a)
                : null === this.typedArray &&
    ...
    (SPE.utils = {
        ...
        ensureValueOverLifetimeCompliance: function(a, b, c) {
            ...
            var d = this.clamp(a._value.length, b, c),
                ...
                f = Math.max(d, e);
            a._value.length !== f &&
                (a._value = this.interpolateArray(a._value, f)),
                a._spread.length !== f &&
                    (a._spread = this.interpolateArray(a._spread, f));
        },
        interpolateArray: function(a, b) {
            "use strict";
            for (
                var c = a.length,
                    d = ["function" == typeof a[0].clone ? a[0].clone() : a[0]],
                    e = (c - 1) / (b - 1),
                    f = 1;
                b - 1 > f;
                ++f
        ...
        lerpTypeAgnostic: function(a, b, c) {
            ...
            var d,
                e = this.types;
            return typeof a === e.NUMBER && typeof b === e.NUMBER
                ? a + (b - a) * c
                : a instanceof THREE.Vector2 && b instanceof THREE.Vector2
                  ? ((d = a.clone()),
                    (d.x = this.lerp(a.x, b.x, c)),
                    (d.y = this.lerp(a.y, b.y, c)),
                    d)
                  : a instanceof THREE.Vector3 && b instanceof THREE.Vector3
                    ? ((d = a.clone()),
                      (d.x = this.lerp(a.x, b.x, c)),
                      (d.y = this.lerp(a.y, b.y, c)),
                      (d.z = this.lerp(a.z, b.z, c)),
                      d)
                    : a instanceof THREE.Vector4 && b instanceof THREE.Vector4
                      ? ((d = a.clone()),
                        (d.x = this.lerp(a.x, b.x, c)),
                        (d.y = this.lerp(a.y, b.y, c)),
                        (d.z = this.lerp(a.z, b.z, c)),
                        ...
                        d)
                      : a instanceof THREE.Color && b instanceof THREE.Color
                        ? ((d = a.clone()),
        ...
        randomVector3: function(a, b, c, d, e) {
            "use strict";
            var f = c.x + (Math.random() * d.x - 0.5 * d.x),
                g = c.y + (Math.random() * d.y - 0.5 * d.y),
                h = c.z + (Math.random() * d.z - 0.5 * d.z);
            e &&
                ((f = 0.5 * -e.x + this.roundToNearestMultiple(f, e.x)),
                (g = 0.5 * -e.y + this.roundToNearestMultiple(g, e.y)),
                (h = 0.5 * -e.z + this.roundToNearestMultiple(h, e.z))),
        ...
        randomColorAsHex: (function() {
            ...
            return function(b, c, d, e) {
                for (var f = d.length, g = [], h = 0; f > h; ++h) {
                    var i = e[h];
                    a.copy(d[h]),
                        (a.r += Math.random() * i.x - 0.5 * i.x),
                        (a.g += Math.random() * i.y - 0.5 * i.y),
                        (a.b += Math.random() * i.z - 0.5 * i.z),
        ...
        getPackedRotationAxis: (function() {
            ...
            return function(e, f) {
                return (
                    a.copy(e).normalize(),
                    b.copy(f).normalize(),
                    (a.x += 0.5 * -f.x + Math.random() * f.x),
                    (a.y += 0.5 * -f.y + Math.random() * f.y),
                    (a.z += 0.5 * -f.z + Math.random() * f.z),
                    a
                        .normalize()
                        .add(d)
                        .multiplyScalar(0.5),
    ...
    (SPE.Group = function(a) {
        ...
        (a = b.ensureTypedArg(a, c.OBJECT, {})),
            ...
            (this.fixedTimeStep = b.ensureTypedArg(
                a.fixedTimeStep,
                c.NUMBER,
                0.016
            )),
            (this.texture = b.ensureInstanceOf(
                a.texture.value,
                THREE.Texture,
                null
            )),
            (this.textureFrames = b.ensureInstanceOf(
                a.texture.frames,
                THREE.Vector2,
                new THREE.Vector2(1, 1)
            )),
            (this.textureFrameCount = b.ensureTypedArg(
                a.texture.frameCount,
                c.NUMBER,
            ...
            (this.hasPerspective = b.ensureTypedArg(
                a.hasPerspective,
                c.BOOLEAN,
                !0
            )),
            (this.colorize = b.ensureTypedArg(a.colorize, c.BOOLEAN, !0)),
            (this.maxParticleCount = b.ensureTypedArg(
                a.maxParticleCount,
                c.NUMBER,
                null
            )),
            (this.blending = b.ensureTypedArg(
                a.blending,
                c.NUMBER,
            ...
            (this.alphaTest = parseFloat(
                b.ensureTypedArg(a.alphaTest, c.NUMBER, 0)
            )),
    ...
    (SPE.Group.prototype._updateDefines = function() {
        ...
        for (c; c >= 0; --c)
            (a = b[c]),
                d.SHOULD_CALCULATE_SPRITE ||
                    (d.SHOULD_ROTATE_TEXTURE =
                        d.SHOULD_ROTATE_TEXTURE ||
                        !!Math.max(
                            Math.max.apply(null, a.angle.value),
                            Math.max.apply(null, a.angle.spread)
                        )),
                (d.SHOULD_ROTATE_PARTICLES =
                    d.SHOULD_ROTATE_PARTICLES ||
                    !!Math.max(a.rotation.angle, a.rotation.angleSpread)),
                (d.SHOULD_WIGGLE_PARTICLES =
                    d.SHOULD_WIGGLE_PARTICLES ||
                    !!Math.max(a.wiggle.value, a.wiggle.spread));
    ...
    (SPE.Group.prototype._applyAttributesToGeometry = function() {
        ...
        for (var f in c)
            c.hasOwnProperty(f) &&
                ...
                (b = e[f]),
                b
                    ? (b.array = a.typedArray.array)
                    : d.addAttribute(f, a.bufferAttribute),
    ...
    (SPE.Group.prototype.removeEmitter = function(a) {
        ...
        for (var g in this.attributes)
            this.attributes.hasOwnProperty(g) &&
    ...
    (SPE.Group.prototype.releaseIntoPool = function(a) {
        "use strict";
        return a instanceof SPE.Emitter == !1
            ? void console.error("Argument is not instanceof SPE.Emitter:", a)
            : (a.reset(), this._pool.unshift(a), this);
    }),
    ...
    (SPE.Group.prototype._triggerSingleEmitter = function(a) {
        ...
        return null === b
            ...
            : (a instanceof THREE.Vector3 &&
                  (b.position.value.copy(a),
                  (b.position.value = b.position.value)),
              b.enable(),
              setTimeout(function() {
                  b.disable(), c.releaseIntoPool(b);
              }, 1e3 * Math.max(b.duration, b.maxAge.value + b.maxAge.spread)),
              this);
    }),
    ...
    (SPE.Emitter = function(a) {
        ...
        (a = b.ensureTypedArg(a, c.OBJECT, {})),
            ...
            (this.uuid = THREE.Math.generateUUID()),
            (this.type = b.ensureTypedArg(
                a.type,
                c.NUMBER,
                SPE.distributions.BOX
            )),
            (this.position = {
                _value: b.ensureInstanceOf(
                    a.position.value,
                    THREE.Vector3,
                    new THREE.Vector3()
                ),
                _spread: b.ensureInstanceOf(
                    a.position.spread,
                    THREE.Vector3,
                    new THREE.Vector3()
                ),
                _spreadClamp: b.ensureInstanceOf(
                    a.position.spreadClamp,
                    THREE.Vector3,
                    new THREE.Vector3()
                ),
                _distribution: b.ensureTypedArg(
                    a.position.distribution,
                    c.NUMBER,
                    this.type
                ),
                _randomise: b.ensureTypedArg(
                    a.position.randomise,
                    c.BOOLEAN,
                    !1
                ),
                _radius: b.ensureTypedArg(a.position.radius, c.NUMBER, 10),
                _radiusScale: b.ensureInstanceOf(
                    a.position.radiusScale,
                    THREE.Vector3,
                    new THREE.Vector3(1, 1, 1)
                ),
                _distributionClamp: b.ensureTypedArg(
                    a.position.distributionClamp,
                    c.NUMBER,
                    0
                )
            }),
            ...
            (this.rotation = {
                _axis: b.ensureInstanceOf(
                    a.rotation.axis,
                    THREE.Vector3,
                    new THREE.Vector3(0, 1, 0)
                ),
                _axisSpread: b.ensureInstanceOf(
                    a.rotation.axisSpread,
                    THREE.Vector3,
                    new THREE.Vector3()
                ),
                _angle: b.ensureTypedArg(a.rotation.angle, c.NUMBER, 0),
                _angleSpread: b.ensureTypedArg(
                    a.rotation.angleSpread,
                    c.NUMBER,
                    0
                ),
                _static: b.ensureTypedArg(a.rotation["static"], c.BOOLEAN, !1),
                _center: b.ensureInstanceOf(
                    a.rotation.center,
                    THREE.Vector3,
            ...
            (this.color = {
                _value: b.ensureArrayInstanceOf(
                    a.color.value,
                    THREE.Color,
                    new THREE.Color()
                ),
                _spread: b.ensureArrayInstanceOf(
                    a.color.spread,
                    THREE.Vector3,
                    new THREE.Vector3()
                ),
            ...
            (this.particleCount = b.ensureTypedArg(
                a.particleCount,
                c.NUMBER,
                100
            )),
            ...
            (this.activeMultiplier = b.ensureTypedArg(
                a.activeMultiplier,
                c.NUMBER,
                1
            )),
            ...
            (this.resetFlags = {
                position:
                    b.ensureTypedArg(a.position.randomise, c.BOOLEAN, !1) ||
                    b.ensureTypedArg(a.radius.randomise, c.BOOLEAN, !1),
                velocity: b.ensureTypedArg(a.velocity.randomise, c.BOOLEAN, !1),
                acceleration:
                    b.ensureTypedArg(a.acceleration.randomise, c.BOOLEAN, !1) ||
                    b.ensureTypedArg(a.drag.randomise, c.BOOLEAN, !1),
                rotation: b.ensureTypedArg(a.rotation.randomise, c.BOOLEAN, !1),
                rotationCenter: b.ensureTypedArg(
                    a.rotation.randomise,
                    c.BOOLEAN,
                    !1
                ),
        ...
        for (var e in this.updateMap)
            this.updateMap.hasOwnProperty(e) &&
                ((this.updateCounts[this.updateMap[e]] = 0),
                ...
                Object.defineProperty(a, e, {
                    ...
                    set: (function(a) {
                        return function(d) {
                            ...
                            "_rotationCenter" === a
                                ? ((c.updateFlags.rotationCenter = !0),
                                  (c.updateCounts.rotationCenter = 0))
                                : "_randomise" === a
                                  ? (c.resetFlags[e] = d)
                                  : ((c.updateFlags[e] = !0),
                                    (c.updateCounts[e] = 0)),
    ...
    (SPE.Emitter.prototype._calculatePPSValue = function(a) {
        ...
        this.duration
            ? (this.particlesPerSecond =
                  b / (a < this.duration ? a : this.duration))
            : (this.particlesPerSecond = b / a);
    }),
        ...
        switch (h) {
            ...
            case b.SPHERE:
                c.randomVector3OnSphere(
                    ...
                    d._radiusScale,
                    d._spreadClamp.x,
                    d._distributionClamp || this.particleCount
                );
                break;
            case b.DISC:
                c.randomVector3OnDisc(
                    e,
                    a,
                    f,
                    d._radius,
    ...
    (SPE.Emitter.prototype._assignForceValue = function(a, b) {
        ...
        switch (m) {
            ...
            case h.DISC:
                (c = this.attributes.position.typedArray.array),
                    ...
                    (e = c[g + 1]),
                    (f = c[g + 2]),
                    i.randomDirectionVector3OnDisc(
                        this.attributes[b],
                        a,
                        d,
                        e,
        ...
        if ("acceleration" === b) {
            var n = i.clamp(
                i.randomFloat(this.drag._value, this.drag._spread),
                0,
                1
            );
    ...
    (SPE.Emitter.prototype._assignAbsLifetimeValue = function(a, b) {
        ...
        var c,
            ...
            e = this[b],
            f = SPE.utils;
        f.arrayValuesAreEqual(e._value) && f.arrayValuesAreEqual(e._spread)
            ? ((c = Math.abs(f.randomFloat(e._value[0], e._spread[0]))),
              d.setVec4Components(a, c, c, c, c))
            : d.setVec4Components(
                  a,
                  Math.abs(f.randomFloat(e._value[0], e._spread[0])),
                  Math.abs(f.randomFloat(e._value[1], e._spread[1])),
                  Math.abs(f.randomFloat(e._value[2], e._spread[2])),
                  Math.abs(f.randomFloat(e._value[3], e._spread[3]))
              );
    }),
    (SPE.Emitter.prototype._assignAngleValue = function(a) {
        ...
        var b,
            ...
            d = this.angle,
            e = SPE.utils;
        e.arrayValuesAreEqual(d._value) && e.arrayValuesAreEqual(d._spread)
            ? ((b = e.randomFloat(d._value[0], d._spread[0])),
              c.setVec4Components(a, b, b, b, b))
            : c.setVec4Components(
                  a,
                  e.randomFloat(d._value[0], d._spread[0]),
                  e.randomFloat(d._value[1], d._spread[1]),
                  e.randomFloat(d._value[2], d._spread[2]),
                  e.randomFloat(d._value[3], d._spread[3])
              );
    }),
    ...
    (SPE.Emitter.prototype._resetParticle = function(a) {
        ...
        for (
            var b,
                ...
                e = this.updateFlags,
                f = this.updateCounts,
                g = this.attributeKeys,
                h = this.attributeCount - 1;
            h >= 0;
            --h
        )
            (b = g[h]),
                (c = e[b]),
                (d[b] !== !0 && c !== !0) ||
                    (this._assignValue(b, a),
                    this._updateAttributeUpdateRange(b, a),
                    c === !0 && f[b] === this.particleCount
                        ? ((e[b] = !1), (f[b] = 0))
                        : 1 == c && ++f[b]);
    }),
    ...
    (SPE.Emitter.prototype.reset = function(a) {
        ...
        if (((this.age = 0), (this.alive = !1), a === !0)) {
            for (
                var b,
                    c = this.attributeOffset,
                    d = c + this.particleCount,
                    e = this.paramsArray,
                    f = this.attributes.params.bufferAttribute,
                    g = d - 1;
                g >= c;
                --g
            )
